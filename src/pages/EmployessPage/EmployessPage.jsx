                                    ...
                                    {!usersSortableLists[key].length > 0 ? (
                                        ...
                                        <ul>
                                            {usersSortableLists[key].map((userItem) => {
                                                return (
                                                    <li key={uuid()}>
                                                        <div className={`user ${userItem.status === "active" ? "active" : ""}`}>
                                                            <h4>
                                                        ...
                                                        <div className="status">
                                                            <div className="radio">
                                                                <input type="radio" id={"not-active-" + userItem.id} value="not-active" checked={userItem.status === "not-active"} onChange={(event) => handleChangeStatus(event, userItem)} />
                                                                <label htmlFor={"not-active-" + userItem.id}>Not active</label>
                                                            </div>
                                                            <div className="radio">
                                                                <input type="radio" id={"active-" + userItem.id} checked={userItem.status === "active"} value="active" onChange={(event) => handleChangeStatus(event, userItem)} />
                                                                <label htmlFor={"active-" + userItem.id}>Active</label>
                                                            </div>
                                                        </div>
                                                    </li>
                                                );
                                        ...
                                        <ul>
                                            {usersBithdaySortableLists[key].map((userBithdayItem) => {
                                                return (
                                                    <li key={uuid()}>
                                                        <h4>
                                                            {userBithdayItem.firstName} {userBithdayItem.lastName} - {moment(userBithdayItem.dob).format("LL")}
                                                        </h4>
                                                    </li>
                                                );
                                            })}
